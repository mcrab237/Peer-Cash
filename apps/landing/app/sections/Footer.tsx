...
const Footer = () => {
  return (
    <div>
        ...
        <div className="max-w-6xl mx-auto  bg-[#171717] rounded-3xl">
          ...
          >
            <div className="max-w-2xl mx-auto relative z-10">
              <h2 className="text-white text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-6 leading-tight">
                Download Our App Free and Enjoy Exclusive Features!
              </h2>
              <p className="text-white/80 text-sm sm:text-base lg:text-lg mb-8 sm:mb-10 lg:mb-12 leading-relaxed max-w-lg mx-auto">
      ...
      {/**Footer Elements */}
      <footer className="bg-[#F0F0F2] py-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-xl font-bold text-gray-900">PeerCash</span>
              </div>
