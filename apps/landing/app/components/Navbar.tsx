    ...
    <div className="bg-[#f0f0f2] p-6">
      <div className="flex justify-between items-center rounded-full  bg-[#171717] px-6 py-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-semibold font-manrope text-gray-100">PeerCash</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Link
            className="max-md:hidden font-manrope text-black bg-[#D1F701] font-semibold px-6 py-2 rounded-4xl hover:bg-gray-100 transition-colors"
            href="login"
          >
            Download App
          </Link>
